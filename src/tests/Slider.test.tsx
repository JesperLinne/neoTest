...
describe('Slider', () => {
  test('renders the slider with the correct value', () => {
    render(<Slider max={10} min={1} value={5} onChange={() => {}} />)
  ...
  test('renders the label when provided', () => {
    render(<Slider max={10} min={1} value={4} onChange={() => {}} label="Length" />)
  ...
  test('does not render a label when none is provided', () => {
    render(<Slider max={10} min={1} value={4} onChange={() => {}} />)
  ...
  test('calls onChange when the slider value changes', () => {
    ...
    render(<Slider max={10} min={1} value={3} onChange={handleChange} />)
  ...
  test('input element has correct attributes', () => {
    render(<Slider max={20} min={1} value={8} onChange={() => {}} />)
